...
for(k in 1:3){
  if(k==1){load("/project/6003552/widloro/git/TBsim_binbin_case1Exp_Scen2_de_X.RData")}
  if(k==2){load("/project/6003552/widloro/git/TBsim_binbin_case2Exp_Scen2_de_X.RData")}
  if(k==3){load("/project/6003552/widloro/git/TBsim_binbin_case3Exp_Scen2_de_X.RData")}
  for(w in 1:nsim){
    ...
    if(w %in% seq(50,nsim,len=20)){print(w);print(timestamp());save.image("/project/6003552/widloro/git/TBsim_binbin_Exp_Scen2_de_X.RData")}
  }
}
