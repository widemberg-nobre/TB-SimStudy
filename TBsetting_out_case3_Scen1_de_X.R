...
for(k in 3){
  ...
  for(w in 1:nsim){
    ...
    if(w %in% seq(50,nsim,len=20)){print(w);print(timestamp());save.image("/project/6003552/widloro/git/TBsim_binbin_case3_Scen1_de_X.RData")}
  }
}
save.image("/project/6003552/widloro/git/TBsim_binbin_case3_Scen1_de_X.RData")
